...
errors.bad_request = function(client, details)
   errors.send_error_response(client, 400, { message = 'Malformed request', details = details })
   copas.close(client)
end

errors.not_found = function(client, details)
   errors.send_error_response(client, 404, { message = 'Resource not found', details = details })
end

errors.method_not_allowed = function(client, details)
   errors.send_error_response(client, 405, { message = 'Unauthorized method', details = details })
end
...
errors.unauthorized = function(client, details)
   errors.send_error_response(client, 401, { message = 'Authentication required', details = details })
   copas.close(client)
end
